...
test("Mime.mimeFor('html') returns text/html, isText=true", () => {
  ...
  assertion(
    ~message="contentType is text/html",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "text/html",
  )
  assertion(~message="isText is true", ~operator="=", (a, b) => a == b, m.isText, true)
})
...
test("Mime.mimeFor('css') returns text/css, isText=true", () => {
  ...
  assertion(
    ~message="contentType is text/css",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "text/css",
...
test("Mime.mimeFor('js') returns text/javascript", () => {
  ...
  assertion(
    ~message="contentType is text/javascript",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "text/javascript",
...
test("Mime.mimeFor('json') returns application/json, isText=false", () => {
  ...
  assertion(~message="isText is false", ~operator="=", (a, b) => a == b, m.isText, false)
})

test("Mime.mimeFor('txt') returns text/plain, isText=true", () => {
  let m = Mime.mimeFor(~ext="txt")
  assertion(
    ~message="contentType is text/plain",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "text/plain",
...
test("Mime.mimeFor('svg') returns image/svg+xml, isText=false", () => {
  ...
  assertion(
    ~message="contentType is image/svg+xml",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "image/svg+xml",
...
test("Mime.mimeFor('png') returns image/png", () => {
  ...
  assertion(
    ~message="contentType is image/png",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "image/png",
...
test("Mime.mimeFor('jpg') returns image/jpeg", () => {
  ...
  assertion(
    ~message="contentType is image/jpeg",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "image/jpeg",
...
test("Mime.mimeFor('gif') returns image/gif", () => {
  ...
  assertion(
    ~message="contentType is image/gif",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "image/gif",
...
test("Mime.mimeFor('webp') returns image/webp", () => {
  ...
  assertion(
    ~message="contentType is image/webp",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "image/webp",
...
test("Mime.mimeFor('ico') returns image/x-icon", () => {
  ...
  assertion(
    ~message="contentType is image/x-icon",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "image/x-icon",
...
test("Mime.mimeFor('wasm') returns application/wasm", () => {
  ...
  assertion(
    ~message="contentType is application/wasm",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "application/wasm",
...
test("Mime.mimeFor('unknown') returns application/octet-stream, isText=false", () => {
  ...
  assertion(
    ~message="contentType is application/octet-stream",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
...
test("Mime.mimeFor('woff2') returns application/octet-stream (REQ-MIME-3 parity gap)", () => {
  ...
  assertion(
    ~message="woff2 is octet-stream (not in fixed table)",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "application/octet-stream",
...
test("Mime.fromPath('index.html') returns text/html, isText=true", () => {
  ...
  assertion(~message="fromPath html", ~operator="=", (a, b) => a == b, m.contentType, "text/html")
  assertion(~message="isText is true", ~operator="=", (a, b) => a == b, m.isText, true)
})

test("Mime.fromPath('/foo/bar.css') returns text/css", () => {
  let m = Mime.fromPath(~path="/foo/bar.css")
  assertion(~message="fromPath css", ~operator="=", (a, b) => a == b, m.contentType, "text/css")
})

test("Mime.fromPath('file.MIME') is case-insensitive", () => {
  let m = Mime.fromPath(~path="file.MIME")
  assertion(
    ~message="MIME is treated as mime",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "application/octet-stream",
...
test("Mime.fromPath('x.html') returns html", () => {
  ...
  assertion(
    ~message="fromPath strips path, gets html",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "text/html",
...
test("Mime.fromPath('noextension') returns octet-stream", () => {
  ...
  assertion(
    ~message="no extension is octet-stream",
    ~operator="=",
    (a, b) => a == b,
    m.contentType,
    "application/octet-stream",
